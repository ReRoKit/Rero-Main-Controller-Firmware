...
typedef enum __attribute__((packed)) {
    ...
    MTR_MSG_TOUCHED,                // Meter touched action ID.
    MTR_MSG_CW,                     // Meter touch & move CW action ID.
    MTR_MSG_CCW,                    // Meter touch & move CCW action ID.
...
*********************************************************************/
    	...
    	#define FONTDEFAULT     Segoe_UI_Semibold_14    //GOLFontDefault
	#endif
