...
//		#warning "define display orientation and resolution";
...
// -----------------------------------
#if defined (GFX_USE_DISPLAY_PANEL_TFT_G240320LTSW_118W_E)
    #define GFX_USE_TCON_HX8238	//#define USE_TCON_SSD1289
...
*********************************************************************/
    ...
    #elif defined (GFX_USE_DISPLAY_CONTROLLER_ILI9341)
...
//		#warning "definition for PMP interface!";

        // Definitions for reset pin
        #define DisplayResetConfig()        TRISDCLR = _TRISD_TRISD9_MASK   
        #define DisplayResetEnable()        LATDCLR = _LATD_LATD9_MASK
        #define DisplayResetDisable()       LATDSET = _LATD_LATD9_MASK

        // Definitions for RS pin
        #define DisplayCmdDataConfig()      TRISDCLR = _TRISD_TRISD11_MASK
        #define DisplaySetCommand()         LATDCLR = _LATD_LATD11_MASK
        #define DisplaySetData()            LATDSET = _LATD_LATD11_MASK
