...
//		#define DEGREE_START    - 89    // Defines the start angle to draw the meter.
//      #define DEGREE_END      270     // Defines the end angle to draw the meter.
...
// These selects the other parameters of the meter that are dependent on the shape.
    #if (METER_TYPE == MTR_WHOLE_TYPE)
	#define DEGREE_START    -90    // Defines the start angle to draw the meter.
       	#define DEGREE_END      269      // Defines the end angle to draw the meter.
...
typedef struct
{
    ...
    SHORT       degree;         // RERO: Degree of touch position
