...
//        // Assume it's bluetooth v4.0...
//        // Enable the bluetooth module in AT mode.
//        // The baudrate will always be 9600.
//        BT_AT_MODE = AT;
//        BT_RESET = 1;
//        vUART2SetBaudRate(BT4_BT05_BAUDRATE);
//
//
//        // Flush the Rx FIFO.
//        vUART2FlushRxBuffer();
...
//        }
//        // Timeout did not occur.
//        // This means the bluetooth module is DX-BT05.
//        else {
//            eBtVersion = BT_V40_BT05;
//        } 
 ...
 ******************************************************************************/    
    ...
    // Bluetooth v4.0 Dual Mode (EDR+BLE) or BLE Mode only.
        ...
        // --- END: AUTO WRITE ADDRESS TO NAME ---
 ...
 *      DX-BT05 
 ******************************************************************************/    
//    // Bluetooth v4.0 DX-BT05.
//    if (eBtVersion == BT_V40_BT05) {
//        // Flush the Rx FIFO.
//        vUART2FlushRxBuffer();
//
//        // Change the baudrate to 9600.
//        const unsigned char pucSetBaudCommand[] = "AT+BAUD4\r\n";
//        while (uiUART2GetTxSpace() < (sizeof(pucSetBaudCommand) - 1));
//        uiUART2Write(pucSetBaudCommand, sizeof(pucSetBaudCommand) - 1);
//
//        // Wait until +BAUD=4\r\nOK\r\n is received.
//        // We don't check the received string here. We only expect to receive 13 bytes of data.
//        if (prv_uiReadBluetooth(prv_pucRxBuffer, 13, BT_RX_TIMEOUT) < 13) {
//            // Timeout occurred.
//            // Set the error flag.
//            xSystemError.bBluetoothError = 1;
...
//
//        // Set as slave.
//        const unsigned char pucSetSlaveCommand[] = "AT+ROLE0\r\n";
//        while (uiUART2GetTxSpace() < (sizeof(pucSetSlaveCommand) - 1));
//        uiUART2Write(pucSetSlaveCommand, sizeof(pucSetSlaveCommand) - 1);
//
//        // Wait until +ROLE=0\r\nOK\r\n is received.
...
//        uiUART2Write("\r\n", 2);
//
//        // Wait until +NAME=<param>\r\n05OK\r\n is received.
//        // We don't check the received string here. We only expect to receive 16 bytes of data.
//        if (prv_uiReadBluetooth(prv_pucRxBuffer, (strlen(pucRobotName)+12), BT_RX_TIMEOUT) < (strlen(pucRobotName)+12)) {
//            // Timeout occurred.
//            // Set the error flag.
//            xSystemError.bBluetoothError = 1;
//
...
//
//        // Read the bluetooth address.
//        const unsigned char pucReadAddressCommand[] = "AT+LADDR\r\n";
//        while (uiUART2GetTxSpace() < (sizeof(pucReadAddressCommand) - 1));
//        uiUART2Write(pucReadAddressCommand, sizeof(pucReadAddressCommand) - 1);
//
//        // Read the address.
...
//        }
//        
//        // The response will be in this format: "+LADDR=00:15:83:31:19:FA".
//        // Extract the address from the buffer without the header and deliminator.
//        strncpy(&szBluetoothAddress[0], &pucAddressBuffer[7], 2);
//        strncpy(&szBluetoothAddress[2], &pucAddressBuffer[10], 2);
//        strncpy(&szBluetoothAddress[4], &pucAddressBuffer[13], 2);
//        strncpy(&szBluetoothAddress[6], &pucAddressBuffer[16], 2);
//        strncpy(&szBluetoothAddress[8], &pucAddressBuffer[19], 2);
//        strncpy(&szBluetoothAddress[10], &pucAddressBuffer[22], 2);
//        szBluetoothAddress[12] = 0;
//        
//        // Convert the lowercase to upper case character.
//        unsigned char i;
...
//
//        // Read the firmware version.
//        unsigned char pucFirmwareVersionBuffer[43];
//        if (prv_uiReadBluetooth(pucFirmwareVersionBuffer, 43, BT_RX_TIMEOUT) < 43) {
//            // Timeout occurred.
//            // Set the error flag.
//            xSystemError.bBluetoothError = 1;
//
...
//        }
//        
//        // The response will be in this format: "+VERSION=Firmware V3.0.6,Bluetooth V4.0 LE".
//        // Extract the address from the buffer without the header and delimiter.
//        strncpy(&szBTFirmwareVersion[0], "DX-BT05 ", 8); ;
//        strncpy(&szBTFirmwareVersion[8], &pucFirmwareVersionBuffer[18], 6);
//        szBTFirmwareVersion[14] = 0;
//        
//    }
