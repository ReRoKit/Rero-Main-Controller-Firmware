...
#define SETTINGS_SUBPAGE_TOP        WND_SUBPAGE_TOP
#define SETTINGS_SUBPAGE_BOTTOM     (WND_SUBPAGE_BOTTOM - MARGIN_BOTTOM - BTN_PREV_NEXT_HEIGHT - 1)
#define SETTINGS_SUBPAGE_LEFT       WND_SUBPAGE_LEFT
