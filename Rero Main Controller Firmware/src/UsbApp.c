...
static USB_HANDLE USBOutHandle = 0;  //Needs to be initialized to 0 at startup.
static USB_HANDLE USBInHandle = 0;   //Needs to be initialized to 0 at startup.

static unsigned char ReceivedDataBuffer[64];
static unsigned char ToSendDataBuffer[64];
